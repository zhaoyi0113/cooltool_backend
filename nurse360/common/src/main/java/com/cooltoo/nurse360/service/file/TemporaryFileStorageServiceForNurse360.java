 ...
 */
@Service("TemporaryNurse360FileStorageService")
public class TemporaryFileStorageServiceForNurse360 extends AbstractFileStorageServiceForNurse360 {

    private static final Logger logger = LoggerFactory.getLogger(TemporaryFileStorageServiceForNurse360.class.getName());

    @Value("${nurse360.storage.tmp.path}")
