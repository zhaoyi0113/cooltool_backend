...
public class ServiceOrderServiceTest extends AbstractCooltooTest {
    ...
    public void countOrderByConditions() {
        ...
        long count = orderService.countOrderByConditions(null, userId, null, null, null, null, null, null);
        Assert.assertEquals(4, count);

        count = orderService.countOrderByConditions(null, null, categoryId, null, null, null, null, null);
        Assert.assertEquals(3, count);

        count = orderService.countOrderByConditions(null, null, null, topCategoryId, null, null, null, null);
        Assert.assertEquals(6, count);

        count = orderService.countOrderByConditions(null, null, null, null, null, null, null, orderStatus);
    ...
    public void getOrderByConditions() {
        ...
        long topCategoryId = 200;
        OrderStatus orderStatus = OrderStatus.CANCELLED;
        List<ServiceOrderBean> beans = orderService.getOrderByConditions(null, userId, null, null, null, null, null, null, 0, 10);
        ...
        beans = orderService.getOrderByConditions(null, null, categoryId, null, null, null, null, null, 0, 10);
        ...
        beans = orderService.getOrderByConditions(null, null, null, topCategoryId, null, null, null, null, 0, 10);
        ...
        beans = orderService.getOrderByConditions(null, null, null, null, null, null, null, orderStatus, 0, 10);
