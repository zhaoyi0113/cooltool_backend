...
public class UserGo2NurseFileStorageServiceTest extends AbstractCooltooTest {


    private static final Logger logger = LoggerFactory.getLogger(UserGo2NurseFileStorageServiceTest.class.getName());
