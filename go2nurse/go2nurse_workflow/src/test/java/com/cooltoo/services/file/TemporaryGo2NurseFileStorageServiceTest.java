...
public class TemporaryGo2NurseFileStorageServiceTest extends AbstractCooltooTest {

    private static final Logger logger = LoggerFactory.getLogger(TemporaryGo2NurseFileStorageServiceTest.class.getName());

    @Autowired
    private TemporaryGo2NurseFileStorageService tempStorage;
