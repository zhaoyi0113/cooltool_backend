...
public class UserDoctorAPI {
    ...
    public Response getByHospitalDepartment(@Context HttpServletRequest request,
        ...
        int countDoctor = (int) doctorService.countDoctor(hospitalId, departmentId, statuses, false);
        List<DoctorBean> doctors = doctorService.getDoctor(hospitalId, departmentId, statuses, false, 0, countDoctor);
        return Response.ok(doctors).build();
    }
}
