...
public class UserConsultationAPI {
    ...
    public Response getConsultation(@Context HttpServletRequest request,
        ...
        List<UserConsultationBean> consultations = userConsultationService.getUserConsultation(false, userId, null, null, content, null, pageIndex, sizePerPage, ConsultationTalkStatus.USER_SPEAK);
