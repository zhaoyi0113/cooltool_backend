...
//        int id = badgeService.addBadge("index.html", 100, 1, null, null);
//        List<BadgeBean> allBadge = badgeService.getBadgeByAbilityType("ALL", 0, 100);
//        Assert.assertTrue(allBadge.size()>0);
    }

    @Test
    public void testCreateBadge2(){
//        int id = badgeService.addBadge("bbb", 100, 100, null, null);
//        List<BadgeBean> allBadge = badgeService.getBadgeByAbilityType("ALL", 0, 100);
//        Assert.assertTrue(allBadge.size()>0);
    }
